...
export class ImperioCommand extends BaseCommand {
  ...
  private async showOverview(message: Message): Promise<void> {
    const embed = new EmbedBuilder()
      ...
      .setDescription(
        `*En el nombre del Emperador, este sistema mide tu devoción y pureza espiritual.*`
      )
      .addFields(
        {
      ...
      .addFields({
        ...
        value:
          '`!capellan imperio rangos` - Ver todos los rangos\n' +
  ...
  private async showRanks(message: Message): Promise<void> {
    const ranks: { rank: UserRank; description: string; requirement: string }[] = [
      {
        rank: 'Herético',
        description: 'Alma perdida en las garras del Caos',
        requirement: 'Pureza neta < -100',
      },
      {
        rank: 'Sospechoso',
        description: 'Bajo vigilancia constante del Ordo Hereticus',
        requirement: 'Pureza neta: -100 a -1',
      },
      {
        rank: 'Ciudadano',
        description: 'Ciudadano básico del Imperium',
        requirement: 'Pureza neta: 0 a 49',
      },
      {
        rank: 'Fiel',
        description: 'Demostró fe verdadera en el Emperador',
        requirement: 'Pureza neta: 50 a 99',
      },
      {
        rank: 'Devoto',
        description: 'Seguidor dedicado de la doctrina imperial',
        requirement: 'Pureza neta: 100 a 199',
      },
      {
        rank: 'Piadoso',
        description: 'Alma verdaderamente pura y devota',
        requirement: 'Pureza neta: 200 a 399',
      },
      {
        rank: 'Santo',
        description: 'Bendecido por la luz dorada del Emperador',
        requirement: 'Pureza neta: 400 a 699',
      },
      {
        rank: 'Mártir',
        description: 'Dispuesto a morir por el Emperador',
        requirement: 'Pureza neta: 700 a 999',
      },
      {
        rank: 'Servo del Emperador',
        description: 'El más alto honor para un mortal',
        requirement: 'Pureza neta: 1000+',
      },
    ];

    const rankText = ranks
      .map(
        ({ rank, description, requirement }) => `**${rank}**\n*${description}*\n📊 ${requirement}\n`
      )
      .join('\n');
    ...
    const embed = new EmbedBuilder()
      ...
      .setDescription(
        '*Los rangos se calculan basándose en tu Pureza Neta (Puntos de Pureza - Puntos de Corrupción):*\n\n' +
          rankText
      )
      .addFields({
        name: '💡 Consejos',
        value:
          '• Usa `!capellan ranking` para ver tu posición\n' +
    ...
    const embed = new EmbedBuilder()
      ...
      .addFields(
        ...
        },
        {
          ...
          value:
            '• **Ser detectado como hereje**: +20-100 puntos\n' +
        ...
        },
        {
          ...
          value:
            '**Pureza Neta = Puntos de Pureza - Puntos de Corrupción**\n\n' +
        ...
        },
        {
          name: '🎯 Estrategia',
          value:
            '• Usa `!capellan sermon` regularmente\n' +
  ...
  private async showPenitence(message: Message): Promise<void> {
    const embed = new EmbedBuilder()
      ...
      .setDescription(
        '*Las penitencias son castigos temporales impuestos por los Inquisidores por comportamiento herético o sospechoso.*'
      )
      .addFields(
        {
          name: '⚖️ ¿Qué son las Penitencias?',
          value:
            '• **Castigos temporales** por comportamiento no imperial\n' +
        ...
        },
        {
          ...
          value:
            '• **+20 Puntos de Corrupción** por cada penitencia asignada\n' +
        ...
        },
        {
          ...
          value:
            '• **Expiración automática** al cumplirse el tiempo\n' +
        ...
        },
        {
          ...
          value:
            '• Los **Inquisidores no pueden** recibir penitencias entre sí\n' +
      ...
      .addFields({
        ...
        value:
          '• Mantén un comportamiento respetuoso y leal\n' +
  ...
  private async showAchievements(message: Message): Promise<void> {
    const embed = new EmbedBuilder()
      ...
      .setDescription(
        '*Los logros son reconocimientos especiales otorgados automáticamente por el sistema por actos destacados de servicio imperial.*'
      )
      .addFields(
        {
          name: '🏆 Tipos de Logros',
          value:
            '• **Logros de Pureza**: Por alcanzar ciertos niveles de pureza\n' +
        ...
        },
        {
          ...
          value:
            '• **Alma Pura**: Alcanzar 500 puntos de pureza neta\n' +
        ...
        },
        {
          ...
          value:
            '• **Prestigio social** dentro del servidor\n' +
        ...
        },
        {
          ...
          value:
            'Usa `!capellan ranking` para ver tu perfil completo, ' +
